package com.alamin1x0.weather.videwmodel
...
class HomeViewModel(private val weatherDataRepository: WeatherDataRepository) : ViewModel() {
    ...
    private val _currentLocaiton = MutableLiveData<CurrentLocationDataState>()
    val currentLocation:LiveData<CurrentLocationDataState> get() = _currentLocaiton
    ...
    private fun emitCurrentLocationUiState(
        ...
        _currentLocaiton.value = currentLocationDataState
    }
